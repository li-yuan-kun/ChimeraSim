...
class NoPInterconnect:
    """Simple FCFS NoP model based on bytes, bandwidth, and base latency."""

    def __init__(self, config: NoPConfig):
        self.config = config
    ...
    def submit(self, num_bytes: int, ready_time_ns: float = 0.0) -> TransferResult:
